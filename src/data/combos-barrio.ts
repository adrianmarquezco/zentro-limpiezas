...
const GARAJES_POR_ARQUETIPO: Record<BarrioArchetype, ContenidoArquetipo> = {
  'bloque-obrero': {
    ...
    speakableIntro: 'Los garajes en los sótanos de los bloques de {barrio} son espacios con décadas de uso sin limpieza profesional: el pavimento acumula manchas de aceite de motor, polvo de caucho de los neumáticos, barro que entra con los vehículos y manchas de humedad en paredes y techo. Zentro Limpiezas trabaja con comunidades de vecinos y particulares de {barrio} para devolver el garaje a un estado correcto de limpieza e higiene.',
    problemaH2: '¿Por qué los garajes de bloque en {barrio} son tan difíciles de limpiar?',
    problemaContent: 'Los garajes en sótano de {barrio} acumulan tres tipos de suciedad distintos: la grasa de motor (requiere desengrasante específico), el polvo de caucho de los neumáticos (aspirado antes de fregar para evitar que se extienda), y las manchas de humedad en paredes que indican filtración o condensación. Sin el producto adecuado, el fregado convencional solo redistribuye el aceite por el suelo sin eliminarlo.',
  ...
  'historico': {
    ...
    speakableIntro: 'Los garajes en los edificios históricos de {barrio} son en muchos casos espacios originalmente no diseñados para ese uso: bajas, cocheras antiguas o sótanos reconvertidos. No tienen desagüe moderno, las paredes son de piedra o ladrillo que absorbe humedad, y el pavimento puede ser de cemento sin tratar o adoquín. Limpiar estos espacios requiere una técnica diferente a la del garaje de bloque estándar.',
    problemaH2: '¿Cómo se limpia un garaje o cochera en {barrio} sin sistema de desagüe moderno?',
    problemaContent: 'Sin desagüe, en los garajes históricos de {barrio} no se puede aplicar agua en grandes cantidades. La técnica correcta es en semi-seco: aspirado profundo, desengrasante aplicado con mopa y recogida del producto con aspirador de agua. Para manchas de aceite antiguas, aplicamos el desengrasante en seco y dejamos actuar antes de retirar.',
  ...
  'chalet': {
    ...
    speakableIntro: 'Los garajes de los chalés y adosados de {barrio} tienen una particularidad respecto a los de bloque: el barro y el polvo del jardín entran con el calzado y los vehículos, las herramientas de jardinería dejan restos orgánicos, y en muchos casos el garaje sirve también de trastero o almacén. La combinación de aceite de motor, polvo de jardín y herramientas requiere una limpieza más completa que la de un garaje estándar.',
    problemaH2: '¿Por qué los garajes de chalé en {barrio} acumulan más suciedad que los de bloque?',
    problemaContent: 'El garaje de un chalé en {barrio} acumula más tipos de suciedad: además del aceite de motor y el polvo de caucho habituales, hay barro del jardín que entra con los vehículos y el calzado, restos de tierra y polvo orgánico de las herramientas de jardinería, y en los que también sirven de trastero, polvo sedimentado sobre cajas y muebles guardados.',
...
const MUDANZAS_POR_ARQUETIPO: Record<BarrioArchetype, ContenidoArquetipo> = {
  ...
  'marinero': {
    ...
    speakableIntro: 'Dejar un piso en {barrio} en perfectas condiciones implica resolver problemas específicos de la zona costera: el salitre de los cristales que se acumula en semanas, las manchas de condensación en paredes y ventanas que deja el invierno marino, y en algunos casos manchas de moho incipiente en baños y cocina por la alta humedad. La limpieza de mudanza en {barrio} trata todos estos problemas antes de la entrega al propietario.',
    problemaH2: '¿Qué problemas de limpieza deja el ambiente marino en los pisos de {barrio}?',
    problemaContent: 'El ambiente marino de {barrio} deja en los pisos tres problemas específicos: salitre en los cristales de todas las ventanas y mamparas, manchas de condensación en paredes y techos de baño y cocina por la alta humedad, y en los pisos más expuestos, manchas de moho en juntas de azulejos y techos. Una limpieza de mudanza correcta en {barrio} debe tratar todos estos puntos con productos específicos.',
  ...
  'industrial': {
    ...
    speakableIntro: 'Cuando un local o nave industrial en {barrio} cambia de arrendatario, la limpieza de entrega es más exigente que la de un piso: hay que tratar la grasa de la actividad industrial anterior, eliminar el polvo de años de producción en paredes y techos, dejar los aseos desinfectados y el suelo de hormigón lo más limpio posible. Zentro Limpiezas trabaja con propietarios de naves y locales de {barrio} para la limpieza de cambio de inquilino.',
    problemaH2: '¿Qué suciedad deja un inquilino industrial al abandonar una nave de {barrio}?',
    problemaContent: 'La actividad industrial anterior deja en los locales y naves de {barrio} una suciedad específica: grasa de maquinaria en suelo y paredes, polvo de actividad (caucho, metal, pintura según el negocio), manchas de aceite e hidrocarburos en el pavimento de hormigón, y aseos con años de uso sin limpieza a fondo. Todo hay que tratarlo antes de que entre el nuevo inquilino.',
...
const TRASTEROS_POR_ARQUETIPO: Record<BarrioArchetype, ContenidoArquetipo> = {
  'bloque-obrero': {
    ...
    speakableIntro: 'Los trasteros en los sótanos de los bloques de {barrio} son de los espacios que más tiempo pasan sin una limpieza profesional. El polvo se asienta en capas sobre el suelo, las cajas y los objetos guardados; la humedad del sótano favorece la aparición de manchas de moho en paredes; y en los trasteros más antiguos hay telarañas en todos los rincones. Zentro Limpiezas limpia trasteros en {barrio} sin mover los objetos que no se solicite mover.',
    problemaH2: '¿Por qué los trasteros en sótano de {barrio} tienen tanto polvo y humedad?',
    problemaContent: 'Los sótanos de los bloques de {barrio} tienen escasa ventilación y son uno de los primeros espacios donde la humedad se asienta en invierno. La condensación en paredes y techo genera manchas de moho que con el tiempo se extienden. El polvo sedimentado en el suelo del trastero es más pesado que el doméstico, con partículas de cemento y tierra que se acumulan sin que el aire lo mueva. Sin aspirado previo, el fregado solo extiende ese polvo sin eliminarlo.',
  ...
  'historico': {
    ...
    speakableIntro: 'Los trasteros en los edificios históricos de {barrio} son a menudo las bajeras o sótanos originales del inmueble: paredes de piedra, suelo de cemento o ladrillo sin desagüe moderno, y una humedad estructural que no tienen los sótanos de los edificios modernos. El polvo que se acumula en estos espacios lleva décadas asentado en capas; el moho en las paredes de piedra es superficial pero persistente; y la limpieza en semi-seco es obligatoria por la ausencia de desagüe.',
    problemaH2: '¿Cómo se limpia un trastero en una bajera histórica de {barrio} sin desagüe?',
    problemaContent: 'Sin desagüe en el suelo, no se puede usar agua en grandes cantidades en los trasteros históricos de {barrio}: habría que sacarla a mano o quedaría generando más humedad. La técnica correcta es en semi-seco: aspirado profundo del polvo, limpieza de paredes con antifúngico aplicado con paño, y fregado del suelo con la mínima cantidad de agua necesaria recogida con aspirador de agua.',
  ...
  'marinero': {
    ...
    speakableIntro: 'Los trasteros en las zonas costeras de {barrio} tienen un problema que no aparece en los del interior: la humedad marina que penetra en el ambiente del trastero deposita salitre en las superficies metálicas, acelera la aparición de moho en paredes y techos, y genera una humedad ambiente que deteriora lo que se guarda dentro. La limpieza del trastero en {barrio} debe incorporar tratamiento de salitre y antifúngico para que el resultado dure.',
    problemaH2: '¿Cómo afecta el ambiente marino de {barrio} a los trasteros?',
    problemaContent: 'El ambiente marino de {barrio} penetra en los trasteros por las juntas de la puerta y la ventilación. El salitre que lleva el aire marino se deposita en las paredes metálicas y actúa como acelerador de la corrosión. La humedad elevada favorece el crecimiento de moho en paredes y techo, especialmente en los más fríos y sin luz. Sin tratamiento, el moho vuelve en semanas; con antifúngico ecológico correctamente aplicado, el intervalo se alarga significativamente.',
